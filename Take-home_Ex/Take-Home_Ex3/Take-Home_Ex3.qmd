...
## 2.4 Plotting Line Chart

```{e}
ggplot(weekly, aes(x = date, y = total_rainfall, color = station, group = station)) +
  geom_line(linewidth = 1, alpha = 0.7) +
  facet_wrap(~station, scales = "free_y") +  # Use facet_wrap for better readability
  theme_minimal() +
  labs(title = "Total Rainfall Over Time",
       x = "Date",
       y = "Total Rainfall (mm)") +
  theme(
    plot.title = element_text(face = "bold", hjust = 0.5),
