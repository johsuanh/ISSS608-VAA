...
### 3.3.4 Check New Summary and Variable Distribution
...
ggplot(ship_cleaned, aes(x = Net_profit_per_Voyage, 
  ...
  facet_wrap(~ factor(Season, levels = c("Spring", "Summer", "Fall", "Winter")), ncol = 4) +
  theme_classic() +  
...
grouped_ggbetweenstats(
  data = ship_cleaned,  
  x = Ship_Type,
  y = Net_profit_per_Voyage,
  grouping.var = Engine_Type,
  type = "np", 
  mean.ci = TRUE, 
