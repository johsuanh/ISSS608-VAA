...
m_usa_long %>%
  ...
  components() %>%
  autoplot()+
  labs(title="STL Decomposition of Singapore-US Trade Trends",subtitle = "Significant residual variation emerges from January 2020 onward.\n# In this plot, value(S$ million) = trend + seasonal + remainder.")+
...
Seasonal-wise, although we can see clear seasonal patterns for each trade type, the range of variation is smaller than in the other three panels, suggesting the seasonal variation isn't significant.
:::
