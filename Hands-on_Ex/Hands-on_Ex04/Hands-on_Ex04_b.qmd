...
|                                                  | **No. of groups \> 2:**                                                                                                                                                                                                                                                                |
|                                                  |                                                                                                                                                                                                                                                                                        |
|                                                  | -   `"parametric"` or `"p"`: Fisher's or Welch's one-way ANOVA ([stats::oneway.test()](https://rdrr.io/r/stats/oneway.test.html))                                                                                                                                                      |
|                                                  |                                                                                                                                                                                                                                                                                        |
|                                                  | -   `"nonparametric"` or `"np"`: Kruskal-Wallis one-way ANOVA ([stats::kruskal.test()](https://rdrr.io/r/stats/kruskal.test.html))                                                                                                                                                     |
|                                                  |                                                                                                                                                                                                                                                                                        |
|                                                  | -   `"robust"` or `"r":` Heteroscedastic one-way ANOVA for trimmed means ([WRS2::t1way()](https://rdrr.io/pkg/WRS2/man/t1way.html)) \>\> remove all the outliers globally.                                                                                                             |
|                                                  |                                                                                                                                                                                                                                                                                        |
|                                                  | -   `"bayes"`: Fisher's ANOVA ([BayesFactor::anovaBF()](https://rdrr.io/pkg/BayesFactor/man/anovaBF.html))                                                                                                                                                                             |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
